            ...
            REPEAT
                ...
                if (Not VarRecipaint1.Contains('')) then begin
                    if srno = 0 then begin
                        ...
                        //BodyText1.AddText('<th > Document Type </th>');
                        BodyText1.AddText('<th align="center"> Vendor Invoice No. </th>');
                        //BodyText1.AddText('<th style="width:5%"> Vendor No </th>');
                        BodyText1.AddText('<th align="center"> Vendor Name     </th>');
                        BodyText1.AddText('<th align="center"> Currency Code  </th>');
                        // BodyText1.AddText('<th style="width:10%"> Amount    </th>');
                        // BodyText1.AddText('<th style="width:10%"> Amount (LCY)     </th>');
                        ...
                        //BodyText1.AddText('<th style="width:5%"> Salesperson Code      </th>');
                    ...
                    if srno <> 0 then begin
                        ...
                        //BodyText1.AddText('<td align="center">' + Format(VLE."Document Type") + '</td>');
                        BodyText1.AddText('<td align="center">' + format(PIH."Vendor Invoice No.") + '</td>');
                        //BodyText1.AddText('<td align="center">' + format(VLE."Vendor No.") + '</td>');
                        ...
                        //BodyText1.AddText('<td align="right">' + Format(VLE.Amount) + '</td>');
                        //BodyText1.AddText('<td align="right">' + Format(VLE."Amount (LCY)") + '</td>');
                        ...
                        // BodyText1.AddText('<td align="left">' + VLE."Shortcut Dimension 3 Code" + '</td>');
                        BodyText1.AddText('</tr>');
                    end;
